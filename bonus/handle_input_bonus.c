...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/07 04:25:01 by jpaul             #+#    #+#             */
/*   Updated: 2024/09/07 06:23:44 by jpaul            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	handle_input(int key, t_info *v)
{
	...
	else if (key == LEFT || key == A)
	{
		...
		v->anime_player = v->img[P_LEFT];
	}
	else if (key == RIGHT || key == D)
	{
		move(v, v->pos[Y], v->pos[X] + 1);
		v->anime_player = v->img[P_RIGHT];
	}
	return (0);
}
